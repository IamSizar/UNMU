...
class _IndexDetailScreenState extends State<IndexDetailScreen> {
  ...
  String _getLocalizedCategory(BuildContext context, String? category) {
    if (category == null) return AppLocalizations(context).market;
  ...
  Widget build(BuildContext context) {
    ...
    final name =
        ...
        (widget.isSentiment ? l10n.marketSentiment : l10n.indexSingular);
    final symbol =
    ...
    return Scaffold(
      ...
      appBar: PlatformAppBar(title: name),
                ...
                children: [
                  ...
                  if (widget.isSentiment)
                    Container(
                      ...
                      child: Text(
                        widget.data['label']?.toString() ?? l10n.neutral,
                        style: TextStyle(
                          color: color,
                          fontWeight: FontWeight.bold,
                          fontSize: 18,
            ...
            sideTitles: SideTitles(
              ...
              getTitlesWidget: (value, meta) {
                ...
                try {
                  ...
                  final label = DateFormat('h:mm a', locale).format(date);
            ...
            getTooltipItems: (touchedSpots) {
              return touchedSpots.map((spot) {
                ...
                if (index >= 0 && index < chartDates.length) {
                  try {
                    final date = DateTime.parse(chartDates[index]);
                    dateLabel = DateFormat('h:mm a', locale).format(date);
                  } catch (_) {}
                }
