...
export const en = {
  ...
  'nav.screening': 'Screening Rules',
  'screening.title': 'Shariah Screening Thresholds',
  'screening.subtitle':
    'The debt-ratio and non-compliant-income cut-points the screener uses to grade every stock.',
  'screening.reviewWarning':
    'Changing these values changes what the app calls "HALAL" for every user, immediately. Confirm with a qualified Shariah advisor before editing production values.',
  'screening.debtGroupTitle': 'Debt ratio (% of assets)',
  'screening.debtGroupSubtitle': 'Total debt divided by total assets.',
  'screening.haramGroupTitle': 'Non-compliant income (% of revenue)',
  'screening.haramGroupSubtitle': 'Interest income divided by total revenue.',
  'screening.debtGood': 'Grade A ceiling',
  'screening.debtPass': 'Grade B ceiling',
  'screening.debtWarn': 'Grade C ceiling',
  'screening.debtFail': 'Hard fail floor',
  'screening.haramGood': 'Grade A ceiling',
  'screening.haramPass': 'Grade B ceiling',
  'screening.haramWarn': 'Grade C ceiling',
  'screening.haramFail': 'Hard fail floor',
  'screening.invalidOrder':
    'Each value must be greater than or equal to the one before it (Grade A ≤ Grade B ≤ Grade C ≤ hard fail, and hard fail ≤ 100%).',
  'screening.save': 'Save thresholds',
  'screening.saved': 'Saved — applied immediately, no restart needed.',
  'screening.saveFailed': 'Failed to save thresholds',
  'screening.loadFailed': 'Failed to load screening thresholds',
  'screening.retry': 'Retry',
  'nav.ads': 'Ads',
...
export const ar: Partial<Record<TranslationKey, string>> = {
  ...
  'nav.screening': 'قواعد الفرز',
  'screening.title': 'حدود الفرز الشرعي',
  'screening.subtitle': 'نسب الدين والدخل غير المتوافق التي يستخدمها الفارز لتقييم كل سهم.',
  'screening.reviewWarning':
    'تغيير هذه القيم يغيّر فوراً ما يعتبره التطبيق "حلالاً" لكل مستخدم. تأكد مع مستشار شرعي مؤهل قبل تعديل القيم في بيئة الإنتاج.',
  'screening.debtGroupTitle': 'نسبة الدين (% من الأصول)',
  'screening.debtGroupSubtitle': 'إجمالي الدين مقسوماً على إجمالي الأصول.',
  'screening.haramGroupTitle': 'الدخل غير المتوافق (% من الإيرادات)',
  'screening.haramGroupSubtitle': 'دخل الفائدة مقسوماً على إجمالي الإيرادات.',
  'screening.debtGood': 'سقف الدرجة A',
  'screening.debtPass': 'سقف الدرجة B',
  'screening.debtWarn': 'سقف الدرجة C',
  'screening.debtFail': 'حد الرسوب',
  'screening.haramGood': 'سقف الدرجة A',
  'screening.haramPass': 'سقف الدرجة B',
  'screening.haramWarn': 'سقف الدرجة C',
  'screening.haramFail': 'حد الرسوب',
  'screening.invalidOrder':
    'يجب أن تكون كل قيمة أكبر من أو تساوي القيمة التي قبلها (A ≤ B ≤ C ≤ حد الرسوب، وحد الرسوب ≤ 100%).',
  'screening.save': 'حفظ الحدود',
  'screening.saved': 'تم الحفظ — يُطبَّق فوراً دون الحاجة لإعادة التشغيل.',
  'screening.saveFailed': 'فشل حفظ الحدود',
  'screening.loadFailed': 'فشل تحميل حدود الفرز',
  'screening.retry': 'إعادة المحاولة',
  'nav.ads': 'الإعلانات',
  'nav.support': 'الدعم',
  'nav.system': 'النظام',
