...
const Map<String, String> feedHubEn = {
  ...
  'socialHub.markets': 'MARKETS',
  'socialHub.marketPulse': 'Market pulse',
  'socialHub.marketPulseSub': 'Live sentiment & global indices',
  'socialHub.sentimentTitle': 'Market sentiment',
  'socialHub.vsPrevClose': 'vs prev',
  'socialHub.indicesTitle': 'INDICES',
  'socialHub.sentExtremeFear': 'Extreme Fear',
  'socialHub.sentFear': 'Fear',
  'socialHub.sentNeutral': 'Neutral',
  'socialHub.sentGreed': 'Greed',
  'socialHub.sentExtremeGreed': 'Extreme Greed',
  'socialHub.communityUnavailableTitle': 'Community Unavailable',
  'socialHub.communityUnavailable': 'This community is currently unavailable.',
...
const Map<String, String> feedHubAr = {
  ...
  'socialHub.markets': 'الأسواق',
  'socialHub.marketPulse': 'نبض السوق',
  'socialHub.marketPulseSub': 'المزاج الحي والمؤشرات العالمية',
  'socialHub.sentimentTitle': 'مزاج السوق',
  'socialHub.vsPrevClose': 'مقابل السابق',
  'socialHub.indicesTitle': 'المؤشرات',
  'socialHub.sentExtremeFear': 'خوف شديد',
  'socialHub.sentFear': 'خوف',
  'socialHub.sentNeutral': 'محايد',
  'socialHub.sentGreed': 'طمع',
  'socialHub.sentExtremeGreed': 'طمع شديد',
  'socialHub.communityUnavailableTitle': 'المجتمع غير متاح',
  'socialHub.communityUnavailable': 'هذا المجتمع غير متاح حاليًا.',
